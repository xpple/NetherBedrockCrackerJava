...
public class __crt_locale_data_public {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        NetherBedrockCracker.C_POINTER.withName("_locale_pctype"),
        NetherBedrockCracker.C_INT.withName("_locale_mb_cur_max"),
        NetherBedrockCracker.C_INT.withName("_locale_lc_codepage")
