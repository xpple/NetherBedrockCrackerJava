...
public class Block {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        NetherBedrockCracker.C_INT.withName("x"),
        NetherBedrockCracker.C_INT.withName("y"),
        NetherBedrockCracker.C_INT.withName("z"),
        NetherBedrockCracker.C_INT.withName("block_type")
    ).withName("Block");
    ...
    private static final OfInt block_type$LAYOUT = (OfInt)$LAYOUT.select(groupElement("block_type"));
     ...
     * }
     */
    public static final OfInt block_type$layout() {
        return block_type$LAYOUT;
    }

    private static final long block_type$OFFSET = 12;
     ...
     * }
     */
    public static final long block_type$offset() {
     ...
     * }
     */
    public static int block_type(MemorySegment struct) {
        return struct.get(block_type$LAYOUT, block_type$OFFSET);
    }
     ...
     * }
     */
    public static void block_type(MemorySegment struct, int fieldValue) {
        struct.set(block_type$LAYOUT, block_type$OFFSET, fieldValue);
    }
